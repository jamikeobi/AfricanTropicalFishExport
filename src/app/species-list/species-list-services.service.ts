...
export class SpeciesListServicesService {
  ...
  private CongoFishList = [
    {id: 1, Fishname: 'Hydrocynus goliath', source: '../../assets/img/CongoFishes/1.mp4'},
    ...
    {id: 6, Fishname: ' Polypterus Mokelembembe', source: "../../assets/img/CongoFishes/6.mp4"},
    {id: 7, Fishname: 'Phenaco aurantiacus', source: "../../assets/img/CongoFishes/7.mp4"},
    {id: 8, Fishname: 'Protopterus dolloi albinos', source: "../../assets/img/CongoFishes/14.mp4"},
    {id: 9, Fishname: 'Distichodus sexfaciastis', source: "../../assets/img/CongoFishes/12.mp4"},
