...
export class SpeciesListServicesService {
  ...
  private CongoFishList = [
    {id: 1, Fishname: 'MBU PUFFER (Tetradon Mbu)', source: '../../assets/img/CongoFishes/1.mp4'},
    {id: 2, Fishname: 'MIRUS PUFFER (Tetradon Mirus ', source: "../../assets/img/CongoFishes/video3.mp4"},
    {id: 3, Fishname: 'ORNATIPINNIS (Polypterus Ornatipinnis)', source: "../../assets/img/CongoFishes/3.mp4"},
    {id: 4, Fishname: ' TETRONDON PUSTULATUS', source: "../../assets/img/CongoFishes/WhatsApp Video 2024-07-17 at 4.26.33 PM.mp4"},
    {id: 5, Fishname: 'POLYPTERUS (Polypterus Palmas) ', source: "../../assets/img/CongoFishes/5.mp4"},
    {id: 6, Fishname: 'D.SEXFASCIATUS', source: "../../assets/img/CongoFishes/6.mp4"},
    {id: 7, Fishname: 'Phenaco aurantiacus', source: "../../assets/img/CongoFishes/7.mp4"},
    {id: 10, Fishname: 'POLYPTERUS RETROPINNIS', source: "../../assets/img/CongoFishes/POLYPTERUS RETROPINNIS.mp4"},
    {id: 11, Fishname: 'TETRAODON SCHOUTEDENI', source: "../../assets/img/CongoFishes/TETRAODON SCHOUTEDENI.mp4"}
